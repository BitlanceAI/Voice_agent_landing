...
export default function Capabilities() {
  return (
    <section id="capabilities" className="py-20 px-4 bg-white">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-black text-slate-900 mb-4">Unlimited Potential</h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
          {capabilities.map((cap, index) => (
            ...
            >
              ...
              <p className="text-sm font-black text-slate-800 leading-tight">{cap.text}</p>
            </motion.div>
          ))}
        </div>
      </div>
